...
int ubik_test_mutextest02(void) {
	...
	r = task_create_noautodel(&_g_ubik_test_task_a[3-1], mutextest02_task3func, NULL, task_getpriority(NULL)-3, 0, "mutextest02 task 3");
	if (0 != r) {
	...
	r = task_create_noautodel(&_g_ubik_test_task_a[1-1], mutextest02_task1func, NULL, task_getpriority(NULL)-1, 0, "mutextest02 task 1");
	if (0 != r) {
		printf("fail at task_create_noautodel(), err=%d\n", r);
		r = -1;
		goto end2;
	...
	r = task_create_noautodel(&_g_ubik_test_task_a[2-1], mutextest02_task2func, NULL, task_getpriority(NULL)-2, 0, "mutextest02 task 2");
	if (0 != r) {
		printf("fail at task_create_noautodel(), err=%d\n", r);
		r = -1;
		goto end2;
