...
static void condvtest02_task1func(void * arg) {
	int r;
	int i;
...
static void condvtest02_task2func(void * arg) {
	int i;
	unsigned int waitvalue = UBINOS__UBIK_TEST__TASKWAITTIMEMS * bsp_getbusywaitcountperms();
...
static void condvtest02_task3func(void * arg) {
	int r;
	int i;
	unsigned int waitvalue = UBINOS__UBIK_TEST__TASKWAITTIMEMS * bsp_getbusywaitcountperms();
...
int ubik_test_condvtest02(void) {
	...
	printf("\n");
	printf("<test>\n");
	printf("<name>ubik_test_condvtest02</name>\n");
	printf("<description>Priority inversion test of condition variable</description>\n");
	...
	r = task_create_noautodel(&_g_ubik_test_task_a[3-1], condvtest02_task3func, NULL, task_getpriority(NULL)-3, 0, "condvtest02 task 3");
	if (0 != r) {
	...
	r = task_create_noautodel(&_g_ubik_test_task_a[1-1], condvtest02_task1func, NULL, task_getpriority(NULL)-1, 0, "condvtest02 task 1");
	if (0 != r) {
		printf("fail at task_create_noautodel(), err=%d\n", r);
		r = -1;
		goto end3;
	...
	r = task_create_noautodel(&_g_ubik_test_task_a[2-1], condvtest02_task2func, NULL, task_getpriority(NULL)-2, 0, "condvtest02 task 2");
	if (0 != r) {
		printf("fail at task_create_noautodel(), err=%d\n", r);
		r = -1;
		goto end3;
