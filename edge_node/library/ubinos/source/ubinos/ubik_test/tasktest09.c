...
int ubik_test_tasktest09(void) {
	...
	r = task_create_noautodel(&_g_ubik_test_task_a[2-1], tasktest09_task2func, NULL, task_getpriority(NULL)-2, 256, "tasktest09 task 2");
	if (0 != r) {
	...
	r = task_create_noautodel(&_g_ubik_test_task_a[1-1], tasktest09_task1func, NULL, task_getpriority(NULL)-1, 256, "tasktest09 task 1");
	if (0 != r) {
		printf("fail at task_create_noautodel(), err=%d\n", r);
		r = -1;
		goto end2;
