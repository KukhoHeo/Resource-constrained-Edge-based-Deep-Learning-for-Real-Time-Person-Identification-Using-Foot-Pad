 ...
 *
 * @param	tickhookfunc 틱 후크 함수 포인터<br>
 ...
 * 스핀 기다림spin waiting을 수행하기 때문에 최대 UBINOS__UBIK__IDLETASK_SPINWAIT_INTERVALTICK 으로 정의된 시스템 틱 수 만큼
 * 응답 시간이 지연될 수 있다.
 *
 ...
 * 			 -n: n-1 번째 매개변수가 잘못되었음<br>
 */
int ubik_setidletaskhookfunc(idletaskhookfunc_ft func, void * arg,
		const char * name, unsigned int option);
