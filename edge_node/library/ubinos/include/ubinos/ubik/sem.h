 ...
 *
 * \section semtest00_sec 간단한 세마포어 사용 예제 Simple semaphore example
 *
 ...
 *
 *
 * \section semtest01_sec 세마포어 기본 기능 시험 Test on basic functions of semaphore
 *
 ...
 *
 * \section semtest04_sec 세마포어에 의한 메모리 누수 시험 Test for memory leak by semaphore
 *
...
{
	unsigned int type :8; /*!< Object type: OBJTYPE__UBIK_SEM */
 ...
 * 			 -n: n-1 번째 매개변수가 잘못되었음<br>
 */
int sem_create_ext(sem_pt * sem_p, unsigned int initcount,
