...
#ifndef UBIK_MUTEX_H_
#define UBIK_MUTEX_H_
 ...
 *
 * \section mutextest00_sec 간단한 뮤텍스 사용 예제 Simple mutex example
 *
 ...
 *
 *
 * \section mutextest01_sec 뮤텍스 기본 기능 시험 Test on basic functions of mutex
 *
 ...
 *
 *
 * \section mutextest02_sec 뮤텍스에 의한 우선순위 역전priority inversion 상황 시험 Test for priority inversion situation by mutex
 *
 ...
 *
 *
 * \section mutextest03_sec 우선순위 역전priority inversion 상황을 방지하는 뮤텍스의 우선순위 상속priority inheritance 특성 시험 Test on priority inheritance feature of mutex preventing priority inversion situation
 *
 ...
 *
 *
 * \section mutextest04_sec 뮤텍스에 의한 메모리 누수 시험 Test for memory leak by mutex
 *
...
{
		unsigned int type :8; /*!< Object type: OBJTYPE__UBIK_MUTEX */
