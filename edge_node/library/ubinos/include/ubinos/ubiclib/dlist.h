...
#ifndef UBICLIB_DLIST_H_
#define UBICLIB_DLIST_H_
 ...
 * @file dlist.h
 *
 * @brief ubiclib double linked list API
 *
...
{
	struct _dlist_elmt_t * prev; /*!< Previous element pointer */
	struct _dlist_elmt_t * next; /*!< Next element pointer */
	void * list; /*!< List pointer to which this element belongs */
	void * data; /*!< Data of this element */
	void * data2; /*!< Data2 of this element */
} dlist_elmt_t;
...
typedef struct _dlist_t
{
	...
	dlist_elmt_pt head; /*!< Head element pointer */
	dlist_elmt_pt tail; /*!< Tail element pointer */
	dlist_elmt_pt cur; /*!< Current element pointer */
	void * data; /*!< Data of this list */
} dlist_t;
