...
#select mode
set_cache(FOOT_ORIGINAL__USE_MULTICHANNEL TRUE BOOL)
set_cache(FOOT_ORIGINAL__USE_ADC FALSE BOOL)
set_cache(FOOT_ORIGINAL__USE_FOOT_TINYML TRUE BOOL)
set_cache(FOOT_ORIGINAL__USE_FOOT_TINYML_TEST TRUE BOOL)
set_cache(FOOT_ORIGINAL__USE_USART FALSE BOOL)
set_cache(FOOT_ORIGINAL__USE_WIFI FALSE BOOL)
set_cache(FOOT_ORIGINAL__USE_PRINT_IMAGE FALSE BOOL)
...
if(FOOT_ORIGINAL__USE_MULTICHANNEL)
    include_directories(${_tmp_source_dir}/multichannel)
else()
    include_directories(${_tmp_source_dir}/original)
endif(FOOT_ORIGINAL__USE_MULTICHANNEL)
...
if(FOOT_ORIGINAL__USE_FOOT_TINYML)

    get_filename_component(_tmp_source_dir "${CMAKE_CURRENT_LIST_DIR}/foot_tinyml" ABSOLUTE)
...
endif(FOOT_ORIGINAL__USE_FOOT_TINYML)
